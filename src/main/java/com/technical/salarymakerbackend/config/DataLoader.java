...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        bank11.setAccountNo(String.valueOf(Utility.getRandomId()));
        ...
        employee11.setEmployeeId(String.valueOf(Utility.getRandomId()));
        ...
        bank21.setAccountNo(String.valueOf(Utility.getRandomId()));
        ...
        employee21.setEmployeeId(String.valueOf(Utility.getRandomId()));
        ...
        bank31.setAccountNo(String.valueOf(Utility.getRandomId()));
        ...
        employee31.setEmployeeId(String.valueOf(Utility.getRandomId()));
        ...
        bank32.setAccountNo(String.valueOf(Utility.getRandomId()));
        ...
        employee32.setEmployeeId(String.valueOf(Utility.getRandomId()));
        ...
        bank41.setAccountNo(String.valueOf(Utility.getRandomId()));
        ...
        employee41.setEmployeeId(String.valueOf(Utility.getRandomId()));
        ...
        bank42.setAccountNo(String.valueOf(Utility.getRandomId()));
        ...
        employee42.setEmployeeId(String.valueOf(Utility.getRandomId()));
        ...
        bank51.setAccountNo(String.valueOf(Utility.getRandomId()));
        ...
        employee51.setEmployeeId(String.valueOf(Utility.getRandomId()));
        ...
        bank52.setAccountNo(String.valueOf(Utility.getRandomId()));
        ...
        employee52.setEmployeeId(String.valueOf(Utility.getRandomId()));
        ...
        bank61.setAccountNo(String.valueOf(Utility.getRandomId()));
        ...
        employee61.setEmployeeId(String.valueOf(Utility.getRandomId()));
        ...
        bank62.setAccountNo(String.valueOf(Utility.getRandomId()));
        ...
        employee62.setEmployeeId(String.valueOf(Utility.getRandomId()));
